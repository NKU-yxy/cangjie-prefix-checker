...
class GrammarShadowMatrixTest(unittest.TestCase):
    ...
    def test_required_statement_and_prefix_families_are_present(self) -> None:
        required = {
            ...
            "digit-tail-field-type",
            "digit-tail-field-initializer",
            "digit-tail-primitive",
            "digit-tail-keyword",
            "digit-tail-short-keyword",
            "digit-tail-comment",
            "identifier-start-after-digit-type",
            "identifier-start-after-digit-initializer",
