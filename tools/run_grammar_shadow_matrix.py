...
def _feature_cases() -> list[Case]:
    ...
    cases = [
        ...
        Case("primitive-float16", "main(): Unit { let value: Float16 = 1.0f16 }", valid, "numbers"),
        Case("generic-identifier-f16", "main(): Unit { let f16: Int64 = 1 }", valid, "numbers"),
        ...
        Case(
            "adjacent-generic-field-comment-gap",
            "class C { a: /* nullable ws */ " + "X" * 32 + "b:B }",
            valid,
            "identifier-literal-adjacency",
        ),
        Case(
            "adjacent-generic-field-initializer-tail",
            "class C { a:A = Xb:B }",
            valid,
            "identifier-literal-adjacency",
        ),
        Case(
            "adjacent-generic-field-trailing-comment",
            "class C { a:Ab /* nullable ws */ :B }",
            valid,
            "identifier-literal-adjacency",
        ),
        Case(
            "adjacent-generic-field-initializer-comment",
            "class C { a:A = Xb /* nullable ws */ :B }",
            valid,
            "identifier-literal-adjacency",
        ),
        Case("digit-tail-field-type", "class C { a:A1:B }", "reject", "identifier-digit-boundary"),
        Case("digit-tail-field-initializer", "class C { a:A = X1:B }", "reject", "identifier-digit-boundary"),
        Case("digit-tail-primitive", "class C { a:u8123:B }", "reject", "identifier-digit-boundary"),
        Case("digit-tail-keyword", "class C { a:A = public123:B }", compare, "identifier-digit-boundary"),
        Case("digit-tail-short-keyword", "class C { a:A = if1:B }", compare, "identifier-digit-boundary"),
        Case("digit-tail-comment", "class C { a:A = if1 /*c*/ :B }", compare, "identifier-digit-boundary"),
        Case("identifier-start-after-digit-type", "class C { a:A1b:B }", valid, "identifier-digit-boundary"),
        Case("identifier-start-after-digit-initializer", "class C { a:A = X1b:B }", valid, "identifier-digit-boundary"),
